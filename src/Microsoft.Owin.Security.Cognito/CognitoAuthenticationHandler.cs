...
using Microsoft.Owin.Security.Cognito.Infrastructure;
using Microsoft.Owin.Security.Infrastructure;

namespace Microsoft.Owin.Security.Cognito
{
    internal class CognitoAuthenticationHandler : AuthenticationHandler<CognitoAuthenticationOptions>
    {
        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;

        public CognitoAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                if (string.Equals("id_res", mode.Value, StringComparison.Ordinal))
                {
                    ...
                    HttpResponseMessage response = await _httpClient.PostAsync("https://www.Cognito.com/accounts/o8/ud", requestBody, Request.CallCancelled);
                ...
                if (messageValidated)
                {
                    ...
                    var context = new CognitoAuthenticatedContext(
                        Context,
                        identity,
                        properties,
                        responseMessage,
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                string authorizationEndpoint =
                    "https://www.Cognito.com/accounts/o8/ud" + this.Options.CognitoDomain +
                ...
                var redirectContext = new CognitoApplyRedirectContext(
                    Context, Options,
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new CognitoReturnEndpointContext(Context, model);
