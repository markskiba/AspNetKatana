...
namespace Microsoft.Owin.Security.Cognito
{
    internal class CognitoOAuth2AuthenticationHandler : AuthenticationHandler<CognitoOAuth2AuthenticationOptions>
    {
        ...
        public CognitoOAuth2AuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new CognitoOAuth2AuthenticatedContext(Context, user, accessToken, refreshToken, expires);
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:Cognito:profile", context.Profile, ClaimValueTypes.String, 
                        Options.AuthenticationType));
                }
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                {
                    // Cognito OAuth 2.0 asks for non-empty scope. If user didn't set it, set default scope to 
                ...
                string authorizationEndpoint = WebUtilities.AddQueryString(Options.CognitoDomain+AuthorizeEndpoint,
                    queryStrings);

                var redirectContext = new CognitoOAuth2ApplyRedirectContext(
                    Context, Options,
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new CognitoOAuth2ReturnEndpointContext(Context, ticket);
