...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Cognito OAuth 2.0 middleware
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Auth",
        Justification = "OAuth2 is a valid word.")]
    public class CognitoOAuth2ApplyRedirectContext : BaseContext<CognitoOAuth2AuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The Cognito OAuth 2.0 middleware options</param>
        ...
        public CognitoOAuth2ApplyRedirectContext(IOwinContext context, CognitoOAuth2AuthenticationOptions options, 
